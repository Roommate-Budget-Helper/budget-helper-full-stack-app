...
resource "aws_route_table_association" "private-b" {
  subnet_id      = aws_subnet.rds-private-subnet-1b
  route_table_id = aws_route_table.RDS-Pvt-rt
}
resource "aws_route_table_association" "private-c" {
  subnet_id      = aws_subnet.rds-private-subnet-1c
  route_table_id = aws_route_table.RDS-Pvt-rt
}
resource "aws_route_table_association" "private-d" {
  subnet_id      = aws_subnet.rds-private-subnet-1d
  route_table_id = aws_route_table.RDS-Pvt-rt
}
resource "aws_route_table_association" "private-f" {
  subnet_id      = aws_subnet.rds-private-subnet-1f
  route_table_id = aws_route_table.RDS-Pvt-rt
}
...
resource "aws_route_table" "RBH-public" {
  ...
  route {
    ...
    gateway_id = aws_internet_gateway.RBH-public-gateway
  }
}

# Subnet associations
resource "aws_route_table_association" "RBH-public-a" {
  route_table_id = aws_route_table.RBH-public
  subnet_id      = aws_subnet.rbh-public-1a
}
