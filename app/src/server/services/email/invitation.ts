...
export const createInvitationTemplate = async () => {
    const params: CreateTemplateRequest = {
        Template: {
            ...
            SubjectPart: "[RBH] A User Has Invited You to Their Home!",
                                          ...
                                          >
                                            <tr>
                                              <td align="left" class="es-p20">
                                                <h3>
                                                  A User Has Invited You To Their Home!
                                                </h3>
                                                <p><br /></p>
                                                <p>
                                                  A user living at {{address}} has invited
                                                  you to join their home!<br /><br />If you
                                                  do not have an account, please feel free
                                                  to signup. The invitation should show up
                                                  under your notifications section as soon
                                                  as you login!
                                                </p>
                                              </td>
                                            </tr>
...
export const sendEmail = async (email: string, address: string) => {
