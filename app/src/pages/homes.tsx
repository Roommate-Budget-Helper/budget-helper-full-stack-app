                    ...
                    <div className="body flex flex-col text-center">
                        ...
                        onClick={handleToggleModal(setMenuOpen)}>
                            ...
                            {isMenuOpen && <div className="absolute top-10 right-10 w-88 bg-slate-50">
                                ...
                                {hasPermission(Permission.Owner) && <div id="owner" className="hover:bg-slate-200 border-b-2 border-black py-2" onClick={handleToggleModal(setEditPermissionsModalOpen)}>Edit Permissions</div>}
