...
const HomesPage: NextPage = () => {
    const createHome = trpc.useMutation(["home.createHome"], {
        ...
        onSuccess: (_, { name }) => {
            console.log("Home %s created successfully", name);
        },
    });
    ...
    const onCreateHome = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        // TODO: Now that home exists, at link creator and home in db
        // Run Mutation on occupies table
    };
    ...
    return (<>
            ...
            <div className="body flex flex-col text-center">
                ...
                <a className="center" href="/bill"><Image src="/images/bills.png" alt="Home" width="35px" height="35px" /></a>
                <a className="center" href="#"><Image src="/images/thing.png" alt="Home" width="35px" height="35px" /></a>
                <a className="active center" onClick={showCreateHomeForm}><Image src="/images/add_home.png" alt="Home" width="60px" height="60px" /></a>
                <a className="center" href="/notification"><Image src="/images/notifications.png" alt="Home" width="35px" height="35px" /></a>
                <a className="center" href="/homes"><Image src="/images/user.png" alt="Home" width="35px" height="35px" /></a>
                </div>
            <div id ="core">
                    ...
                    <div className="center"><Image src="/images/logo.png" alt="Home" width="100px" height="100px" /></div>
                        ...
                        <br></br>
                    <div>Feel free to create one using the plus button, or contact your home creator to invite you!</div>
                        </div>
                    </div>
                </div>
    </>);
